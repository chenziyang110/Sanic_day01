    ...
    data() {
      return {
        ...
        ruleForm: {
          ...
          items: [
            { title: '调整基本工资', newValue: '3000', oldValue: '3000' },
            { title: '调整底薪', newValue: '2000', oldValue: '2000' },
            { title: '调整岗位工资', newValue: '2000', oldValue: '2000' },
            { title: '工资合计', newValue: '2000', oldValue: '2000' },
            { title: '调整幅度', newValue: '2000', oldValue: '2000' },
