      ...
      <el-card :style="{minHeight:boxHeight}">
        ...
        <div class="leaveInfo">
          <el-row>
            ...
            <el-col :span="20">
              <div class="headInfo">
                <p><strong>{{formBase.fullName}}</strong></p>
                <p><span>手机</span><em>{{formBase.mobilePhone}}</em><span>部门</span><em>{{formBase.department}}</em></p>
                <p><span>入职时间</span><em>{{formBase.timeOfEntry}}</em></p>
              </div>
            </el-col>
          </el-row>
        </div>
        <div>
           <el-form :rules="ruleInline" ref="dataForm" :model="formBase" label-position="right" label-width="120px"  style='margin-left:200px;width:60%;'>
              ...
              <el-form-item prop="directReports">
                <span slot="label">直属下属数量：</span>
                <el-input placeholder="0" disabled v-model="formBase.directReports" class="inputW"></el-input>
              </el-form-item>
           </el-form>
