           ...
           <el-form :rules="ruleInline" ref="dataForm" :model="formData" label-position="right">
                ...
                <el-row :gutter="20">
                  <el-col :span="12">
                      <el-row>
                        ...
                        <el-col :span="18">
                            <component v-bind:is="fileUpload" ref="positive" :formData.sync='formData' :formBase='formData'  :positiveText='positiveText'></component>
                        </el-col>
                      </el-row>
                  </el-col>
                </el-row>
              ...
              <el-form-item class="formInfo">
                <el-row :gutter="20">
                  ...
                  <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                  <el-col :span="11" class="editInfo">
                    <el-select class="filter-item" v-model="formData.taxableCity">
                      <el-option v-for="item in cityList" 
                      :key="item.id" 
                      :label="item.title" 
                      :value="item.title">
    ...
    getObjInfo() {
      adjustDetail({ id: this.$route.params.id }).then(ret => {
        ...
        if (ret.data.headPortrait !== '') {
          this.fillDownload(ret.data.headPortrait)
        }
      })
    },
