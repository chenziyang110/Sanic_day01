<template>
  <div class='finish_room'>
    <div class='finish_room2'>
        ...
        <div v-else>
            <el-upload action="/upfile" :data= "fullUpType" :file-list="fileList" :class="{disabled:uploadDisabled}" :headers="myheader" :on-success="uploadSuccess" :on-remove="handleRemove" list-type="picture-card">
             <span>{{textTip}}</span>
